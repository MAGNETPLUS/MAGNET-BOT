...
function changeDes(MAGNET-BOT-Company)
assert (tdbot_function ({
_ = 'changeChannelDescription',
channel_id = getChatId(MAGNET-BOT).id,
description = Company
}, dl_cb, nil))
end
...
function getChannelFull(MAGNET-BOT-Company)
assert (tdbot_function ({
_ = 'getChannelFull',
channel_id = getChatId(MAGNET-BOT).id
}, Company, nil))
...
MsgType = 'text'
 ...
 if msg.content._== "messageText" then
local function GetM(Company,MAGNET-BOT)
local function GetName(Companys,Company)
print("\027[" ..color.blue[1].. "m["..os.date("%H:%M:%S").."]\027[00m ["..MAGNET-BOT.title.."] "..Company.first_name.." >>>> "..msg.content.text.."")
end
...
function GetM(Company,MAGNET-BOT)
function GetName(Companys,Company)
print("["..os.date("%H:%M:%S").."] "..MAGNET-BOT.title.." "..Company.first_name.." >>>> "..msg.content.caption.."")
end
GetUser(msg.sender_user_id,GetName)
end
GetChat(msg.chat_id,GetM)
...
print("["..os.date("%H:%M:%S").."] "..MAGNET-BOT.title.." "..Company.first_name.." >>>> Added members "..msg.content.member_user_ids[i].." "..Company.first_name.."")
MsgType = 'AddUser'
end
end
GetUser(msg.sender_user_id,GetName)
...
function GetM(Company,MAGNET-BOT)
function GetName(Companys,Company)
print("["..os.date("%H:%M:%S").."] "..MAGNET-BOT.title.." >>>> Joined By link "..Company.first_name.."")
...
function GetM(Company,MAGNET-BOT)
function GetName(Companys,Company)
print("["..os.date("%H:%M:%S").."] "..MAGNET-BOT.title.." "..Company.first_name.." >>>>[messageDocument][  "..Company.id.."]")
MsgType = 'Document'
end
GetUser(msg.sender_user_id,GetName)
end
...
function ByAddUser(MAGNET-BOT-Company)
...
function WelcomeByLink(MAGNET-BOT-Company)
...
function WelcomeByAddUser(MAGNET-BOT-Company)
print('New User : \nChatID : '..msg.chat_id..'\nUser ID : '..msg.add..'')
if redis:get('Text:Welcome:'..msg.chat_id) then
txtt = redis:get('Text:Welcome:'..msg.chat_id)
else
...
function Test(MAGNET-BOT-Company)
...
local function GetName(MAGNET-BOT, Company)
...
local function SetRank_Rep(MAGNET-BOT, Company)
...
local function SetOwner_Rep(MAGNET-BOT, Company)
local user = Company.sender_user_id
...
function SetOwnerByUsername(MAGNET-BOT-Company)
if Company.id then
print(''..Company.id..'')
...
local function RemOwner_Rep(MAGNET-BOT, Company)
local user = Company.sender_user_id
...
function RemOwnerByUsername(MAGNET-BOT-Company)
if Company.id then
print(''..Company.id..'')
if redis:sismember('OwnerList:'..msg.chat_id, Company.id) then
...
function GbanByReply(MAGNET-BOT-Company)
...
function BanallByUsername(MAGNET-BOT-Company)
if Company.id then
print(''..Company.id..'')
...
function UnbanallByUsername(MAGNET-BOT-Company)
...
function UnGbanByReply(MAGNET-BOT-Company)
if tonumber(Company.sender_user_id) == tonumber(TD_ID) then
sendText(msg.chat_id, msg.id,  '⇜ من نمیتوانم پیام خودم را چک کنم', 'md')
return false
end
...
function CleanMembers(MAGNET-BOT, Company) 
...
local function Clean(MAGNET-BOT-Company)
for k,v in pairs(Company.members) do
...
function list(MAGNET-BOT-Company)
for k,v in pairs(Company.members) do
local function Checkdeleted(MAGNET-BOT-Company)
...
function PromoteByReply(MAGNET-BOT-Company)
...
function DemoteByReply(MAGNET-BOT-Company)
...
function DemoteByUsername(MAGNET-BOT-Company)
if Company.id then
print(''..Company.id..'')
...
function PromoteByUsername(MAGNET-BOT-Company)
if Company.id then
print(''..Company.id..'')
...
function DelallByReply(MAGNET-BOT-Company)
if tonumber(Company.sender_user_id) == tonumber(TD_ID) then
...
function DelallByUsername(MAGNET-BOT-Company)
if tonumber(Company.id) == tonumber(TD_ID) then
  sendText(msg.chat_id, msg.id, "⇜ من نمیتوانم پیام های خودم را پاک کنم", "md")
return false
    end
...
local function CleanBot(MAGNET-BOT-Company)
for k,v in pairs(Company.members) do
if tonumber(v.user_id) == tonumber(TD_ID) then
return false
end
...
function SetVipByReply(MAGNET-BOT-Company)
...
function SetVipByUsername(MAGNET-BOT-Company)
if Company.id then
print('SetVip\nBy : '..msg.sender_user_id..'\nUser : '..Company.id..'\nUserName : '..username)
...
function RemVipByReply(MAGNET-BOT-Company)
if redis:sismember('Vip:'..msg.chat_id, Company.sender_user_id) then
...
function RemVipByUsername(MAGNET-BOT-Company)
if Company.id then
print('RemVip\nBy : '..msg.sender_user_id..'\nUser : '..Company.id..'\nUserName : '..username)
if redis:sismember('Vip:'..msg.chat_id,Company.id) then
...
time = times * 3600
local function Restricted(MAGNET-BOT-Company)
if tonumber(Company.sender_user_id) == tonumber(TD_ID) then
sendText(msg.chat_id, msg.id,  '⇜ من نمیتوانم خودم را محدود کنم ', 'md')
return false
end
...
function Restricted(MAGNET-BOT-Company)
if tonumber(Company.sender_user_id) == tonumber(TD_ID) then
sendText(msg.chat_id, msg.id,  '⇜ من نمیتوانم پیام خودم را چک کنم', 'md')
return false
end
...
function GeTLink(MAGNET-BOT-Company)
...
function BanByReply(MAGNET-BOT-Company)
if tonumber(Company.sender_user_id) == tonumber(TD_ID) then
sendText(msg.chat_id, msg.id,"⇜ من نمیتوانم خودم را محدود کنم",  'md' )
return false
end
...
function UnBanByUserName(MAGNET-BOT-Company)
if tonumber(Company.id) == tonumber(TD_ID) then
sendText(msg.chat_id, msg.id,  '⇜ من نمیتوانم پیام خودم را چک کنم', 'md')
return false
end
...
function UnBan_by_reply(MAGNET-BOT-Company)
if tonumber(Company.sender_user_id) == tonumber(TD_ID) then
sendText(msg.chat_id, msg.id,  '⇜ من نمیتوانم پیام خودم را چک کنم', 'md')
return false
end
...
print '                     Private                          '
function BanByUserName(MAGNET-BOT-Company)
if tonumber(Company.id) == tonumber(TD_ID) then
sendText(msg.chat_id, msg.id,"⇜ من نمیتوانم خودم را مسدود کنم",  'md' )
return false
end
...
function kick_by_reply(MAGNET-BOT-Company)
if tonumber(Company.sender_user_id) == tonumber(TD_ID) then
...
function KickByUserName(MAGNET-BOT-Company)
if tonumber(Company.id) == tonumber(TD_ID) then
sendText(msg.chat_id, msg.id,"⇜ من نمیتوانم خودم را اخراج کنم",  'md' )
return false
end
...
function GetPanel(MAGNET-BOT-Company)
...
local function Get(MAGNET-BOT, Companys)
local function GetName(MAGNET-BOT, Company)
local chat = msg.chat_id
...
function WarnByReply(MAGNET-BOT-Company)
if tonumber(Company.sender_user_id) == tonumber(TD_ID) then
sendText(msg.chat_id, msg.id,  '⇜ من نمیتوانم پیام خودم را چک کنم', 'md')
return false
end
...
function UnWarnByReply(MAGNET-BOT-Company)
if tonumber(Company.sender_user_id) == tonumber(TD_ID) then
...
function IdByUserName(MAGNET-BOT-Company)
if Company.id then
text = '`'..Company.id..'`'
sendText(msg.chat_id, msg.id, text, 'md')
end
...
function GetID(MAGNET-BOT, Company)
local user = Company.sender_user_id
local text = ""..user..""
...
function GetPro1(MAGNET-BOT, Company)
...
local function Whois(MAGNET-BOT-Company)
...
function Webpage(MAGNET-BOT-Company)
...
function GetPro(MAGNET-BOT, Company)
...
local function FullInfo(MAGNET-BOT-Company)
